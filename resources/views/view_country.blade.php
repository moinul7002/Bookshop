            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <tr>
                            <th>{{ $data->country }}</th>
                            <th><a class="btn btn-success" href="{{ route('edit_country',$data->id) }}">Edit</a></th>
                            <th><a class="btn btn-success" href="{{ route('delete_country',$data->id) }}">Delete</a></th>
                                @endforeach
                                </table>

                                <form method="POST" action="{{ route('add_country') }}" aria-label="{{ __('add_category') }}" style="padding-top:20px">
                                    @csrf
