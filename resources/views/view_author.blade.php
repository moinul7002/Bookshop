                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <tr>
                            ...
                            <th><a class="btn btn-success" href="{{ route('edit_author',$data->id) }}">Edit</a></th>
                            <th><a class="btn btn-success" href="{{ route('delete_author',$data->id) }}">Delete</a></th>
                                @endforeach
                                </table>

                                <form method="POST" action="{{ route('add_author') }}" aria-label="{{ __('add_category') }}" style="padding-top:20px">
                                    @csrf
