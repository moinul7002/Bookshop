                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <th><a class="btn btn-success" href="<?php echo e(route('edit_country',$data->id)); ?>">Edit</a></th>
                            <th><a class="btn btn-success" href="<?php echo e(route('delete_country',$data->id)); ?>">Delete</a></th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </table>

                                <form method="POST" action="<?php echo e(route('add_country')); ?>" aria-label="<?php echo e(__('add_category')); ?>" style="padding-top:20px">
                                    <?php echo csrf_field(); ?>
                                    Add Author:<input id="country" type="text" name="country" style="width:200px" >
