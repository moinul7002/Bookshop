            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                        ...
                        <tr>
                            <th><?php echo e($data->feature); ?></th>
                            <th><a class="btn btn-success" href="<?php echo e(route('edit_feature',$data->id)); ?>">Edit</a></th>
                            <th><a class="btn btn-success" href="<?php echo e(route('delete_feature',$data->id)); ?>">Delete</a></th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </table>

                                <form method="POST" action="<?php echo e(route('add_feature')); ?>" aria-label="<?php echo e(__('add_feature')); ?>" style="padding-top:20px">
                                    <?php echo csrf_field(); ?>
