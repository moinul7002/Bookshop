...
<head>
	...
	<link rel="shortcut icon" href="<?php echo e(asset('public/css/images/favicon.ico')); ?>"  />
	<link rel="stylesheet" href="<?php echo e(asset('css/style.css')); ?>" type="text/css" media="all" />
	<script type="text/javascript" src="<?php echo e(asset('js/jquery-1.6.2.min.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('js/jquery.jcarousel.min.js')); ?>"></script>
	<!--[if IE 6]>
...
<body>
	...
	<div id="header" class="shell">
		...
		<div id="login-details">
			<?php if(Auth::user()): ?>
			<p>Welcome, <a href="#" id="user"><?php echo e(Auth::user()->name); ?></a> .</p>
			<?php else: ?>
			<p>Please <a href="#<?php echo e(route('login')); ?>" id="user">Login</a> to Purchase Item.</p>
			<?php endif; ?>
