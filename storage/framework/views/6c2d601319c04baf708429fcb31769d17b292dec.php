            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                        ...
                        <tr>
                            <th><?php echo e($data->author_name); ?></th>
                            <th><a class="btn btn-success" href="<?php echo e(route('edit_author',$data->id)); ?>">Edit</a></th>
                            <th><a class="btn btn-success" href="<?php echo e(route('delete_author',$data->id)); ?>">Delete</a></th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </table>

                                <form method="POST" action="<?php echo e(route('add_author')); ?>" aria-label="<?php echo e(__('add_category')); ?>" style="padding-top:20px">
                                    <?php echo csrf_field(); ?>
                                    Add Author:<input id="author_name" type="text" name="author_name" style="width:200px" >
